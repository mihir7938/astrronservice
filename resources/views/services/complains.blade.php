...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="{{route('services.complains.fetch')}}" class="form" id="fetch-complain" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div id="complain_result">
                        @include('services.list', ['complains' => $complains])
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('#fetch-complain').validate({
            ...
            submitHandler: function (form) {
                $('.loader').show();
                $.ajax({
                    url: "{{ route('services.complains.fetch') }}",
                    method: "POST",
                    headers: {
